...
const tabs = [
  { id: 'clone' as const, label: 'Voice Clone', icon: Mic, requires1_7B: false, group: 'modes' },
  { id: 'design' as const, label: 'Voice Design', icon: Sparkles, requires1_7B: true, group: 'modes' },
  { id: 'custom' as const, label: 'Custom Voice', icon: Users, requires1_7B: false, group: 'modes' },
  { id: 'personalities' as const, label: 'Personalities', icon: UserCircle, requires1_7B: false, group: 'personalities' },
  { id: 'personality-generate' as const, label: 'Speak', icon: Play, requires1_7B: false, group: 'personalities' },
]
...
export function TabNav({ activeTab, onTabChange }: TabNavProps) {
  ...
  const modeTabs = tabs.filter(t => t.group === 'modes')
  const personalityTabs = tabs.filter(t => t.group === 'personalities')
